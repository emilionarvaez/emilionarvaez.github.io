...
document.getElementById('goals').onclick = function changeContent() {
  ...
  if (count == 0) {
    ...
    document.getElementById('goals').style = "Color: #fff600; padding-top: 6%; font-size: 42px; font-family: Cabin, sans-serif; cursor: pointer; max-width: 50%; text-align: center";
  } else {
    count--;
